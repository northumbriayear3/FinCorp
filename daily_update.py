...
REAL_GOLD_FIX_VERSION = "REAL_CRUDE_FEATURE_ALIAS_FIX_V10_RETURN_LAG_COLUMNS_2026_07_29"
...
def unit_source_text(commodity: str) -> str:
    ...
    if commodity == "CRUDE":
        return "REAL_CRUDE_SOURCE_FIX_V9 from saved Crude Oil no-news dissertation models"
    if commodity == "NATGAS":
